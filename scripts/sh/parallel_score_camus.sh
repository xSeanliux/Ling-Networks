...
FACTORS=(1.0 2.0 4.0)
METHODS=(MP4 "ASTRAL\(10,5\)" "ASTRAL\(9,5\)" GA TRUE-CAMUS)
SUFFIXES=("")
# SETTINGS=(mod modhigh high veryhigh)
SETTINGS=(high)
TIMES=1
...
time bash Ling-Networks/scripts/sh/score_sim_camus.sh --factor $f --setting $setting --method $m $SUFFIX_CMD" > $FILENAME
