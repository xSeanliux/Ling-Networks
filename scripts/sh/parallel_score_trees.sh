...
FACTORS=(1.0 2.0 4.0)
# METHODS=(MP4 "ASTRAL\(10,5\)" GA "ASTRAL\(9,5\)"  TRUE-CAMUS)
METHODS=("GA")
SUFFIXES=("")
...
time bash Ling-Networks/scripts/sh/score_sim_trees.sh --factor $f --setting $setting --method $m $SUFFIX_CMD" > $FILENAME
